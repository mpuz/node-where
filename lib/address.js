...
function Address(address, apikey) {
  ...
  this.url = 'https://maps.googleapis.com/maps/api/geocode/json?sensor=false&key=' + apikey + '&address=' + encodeURIComponent(this.address);
}
...
function _resultAddressComponent(body, componentName) {
    ...
    if (body != null && body.address_components != null)
